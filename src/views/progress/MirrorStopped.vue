...
<template>
    <ProgressContainer>
        <div id="progress_close">
            ...
            <div class="progress_img"><img src="@/assets/images/endlink.png" style="margin: 0;" alt="MIrroring END"></div>
            <div class="refresh">
                <div class="refresh_btn">{{ lang.language_json.progress_progress_close_refresh_refresh_btn }}</div>
            </div>
        </div>
    </ProgressContainer>
</template>
